...
#ifndef __dbus_glib_marshal_stack_MARSHAL_H__
#define __dbus_glib_marshal_stack_MARSHAL_H__
...
void
dbus_glib_marshal_stack_VOID__STRING_UINT_STRING_STRING_STRING_BOXED_BOXED_INT_POINTER (GClosure     *closure,
...
extern void dbus_glib_marshal_stack_BOOLEAN__UINT_POINTER (GClosure     *closure,
                                                           ...
                                                           gpointer      marshal_data);
void
dbus_glib_marshal_stack_BOOLEAN__UINT_POINTER (GClosure     *closure,
                                               GValue       *return_value G_GNUC_UNUSED,
                                               guint         n_param_values,
                                               const GValue *param_values,
                                               gpointer      invocation_hint G_GNUC_UNUSED,
...
extern void dbus_glib_marshal_stack_BOOLEAN__POINTER_POINTER (GClosure     *closure,
                                                              ...
                                                              gpointer      marshal_data);
void
dbus_glib_marshal_stack_BOOLEAN__POINTER_POINTER (GClosure     *closure,
                                                  GValue       *return_value G_GNUC_UNUSED,
                                                  guint         n_param_values,
                                                  const GValue *param_values,
                                                  gpointer      invocation_hint G_GNUC_UNUSED,
...
static const DBusGMethodInfo dbus_glib_stack_methods[] = {
  { (GCallback) stack_notify_handler, dbus_glib_marshal_stack_NONE__STRING_UINT_STRING_STRING_STRING_BOXED_BOXED_INT_POINTER, 0 },
  { (GCallback) stack_close_notification_handler, dbus_glib_marshal_stack_BOOLEAN__UINT_POINTER, 147 },
  { (GCallback) stack_get_capabilities, dbus_glib_marshal_stack_BOOLEAN__POINTER_POINTER, 205 },
